  ...
  async (group: THREE.Group) => {
    ...
    await Promise.all([
      ...
      loadStl({
        ...
        pos: [
          [GRID * 52 + UNIT * 0.0, 1.6 + PCB_FACE_TO_KEYCAP_BOTTOM, GRID * 140],
          [GRID * 52 + UNIT * 1.0, 1.6 + PCB_FACE_TO_KEYCAP_BOTTOM, GRID * 140],
          [GRID * 62 + UNIT * 2.0, 1.6 + PCB_FACE_TO_KEYCAP_BOTTOM, GRID * 140],
          [GRID * 62 + UNIT * 3.0, 1.6 + PCB_FACE_TO_KEYCAP_BOTTOM, GRID * 140],
        ],
      }),
    ]);
